    ...
    [
      span({
        ...
        attributes: {
          'cache.status': 'hit',
          'cache.key': 'k-abc',
          'cache.namespace': 'eval.fetch-user',
    ...
    [
      ...
      span({
        ...
        attributes: {
          ...
          'cache.key': 'k-refresh',
          'cache.namespace': 'eval.fetch-plan',
        },
      }),
      span({
        id: 'bypassed',
        ...
        attributes: {
          'cache.status': 'bypass',
          'cache.key': 'k-bypass',
          'cache.namespace': 'eval.fetch-bypass',
        },
      }),
    ],
    [],
