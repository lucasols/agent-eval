    ...
    await withIsolatedExampleWorkspace(async (workspacePath) => {
      ...
      expect(
        ...
        at async open (node:internal/fs/promises:641:25)
            ...
            at async runWithEvalClock.freezeTime (file://<repo>/packages/runner/src/runOrchestration.ts:456:27)
            at async runWithEvalClock (file://<repo>/packages/sdk/src/runtime.ts:356:10)
            at async file://<repo>/packages/runner/src/runOrchestration.ts:452:19
            at async file://<repo>/packages/runner/src/runOrchestration.ts:413:13
            at async runInEvalRuntimeScope (file://<repo>/packages/sdk/src/runtime.ts:761:12)
            at async file://<repo>/packages/runner/src/runOrchestration.ts:412:11",
          "summary": {
            "cancelledCases": 0,
            "errorCases": 0,
