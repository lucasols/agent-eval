              ...
              "outputColumnDefs": [
                {
                  "format": "stars",
                  "isScore": true,
                  "key": "automatedQuality",
                  "kind": "number",
                  "label": "Auto Quality",
                  "maxStars": 5,
                },
                {
                  "description": "Confirm the prepared refund package is ready to send and does not need escalation.",
                  "format": "passFail",
                  "isManualScore": true,
                  "isScore": true,
                ...
                {
                  "description": "Rate whether the response, attachments, and next-step guidance are complete for a support reviewer.",
                  "format": "stars",
                  "isManualScore": true,
                  "isScore": true,
                  "key": "reviewerQuality",
